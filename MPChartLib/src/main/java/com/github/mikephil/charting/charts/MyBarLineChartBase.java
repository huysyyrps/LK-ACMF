...
//        Log.e("TAG","mXAxis.mAxisMinimum"+mXAxis.mAxisMinimum+"-----"+
//                "mXAxis.mAxisRange"+mXAxis.mAxisRange+"-----"+
//                "mAxisLeft.mAxisRange"+mAxisLeft.mAxisRange+"-----"+
//                "mAxisLeft.mAxisMinimum"+mAxisLeft.mAxisMinimum+"-----");
    }
...
//            mXAxisRenderer.computeAxis(mXAxis.mAxisMinimum, mXAxis.mAxisMaximum, false);
//        }else {
//            mXAxisRenderer.computeAxis(mXAxis.mAxisMinimum, mXAxis.mAxisMaximum, true);
//        }
        mXAxisRenderer.computeAxis(mXAxis.mAxisMinimum, mXAxis.mAxisMaximum, false);
